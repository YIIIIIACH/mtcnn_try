...
model = tf.keras.Sequential([tf.keras.layers.Conv2D(20, 3, 3, input_shape = (192,192, 3), activation = 'relu'),
...
model.load_weights('exp_load_img_cnn_weight.h5')
model.fit(ds, epochs=30, steps_per_epoch=50)
